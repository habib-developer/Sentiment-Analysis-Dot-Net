...
namespace SentimentAnalysisDotNetML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"G:\C# Corner Stuff\Semantic Analysis\wikiDetoxAnnotated40kRows.tsv";
        private static string MODEL_FILEPATH = @"../../../../SentimentAnalysisDotNetML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Categorical.OneHotEncoding(new[] { new InputOutputColumnPair("logged_in", "logged_in"), new InputOutputColumnPair("ns", "ns"), new InputOutputColumnPair("sample", "sample") })
                                      .Append(mlContext.Transforms.Text.FeaturizeText("comment_tf", "comment"))
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "logged_in", "ns", "sample", "comment_tf", "year" }))
